...
const ExpenseSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'categoryEnum': PropertySchema(
      id: 1,
      name: r'categoryEnum',
      type: IsarType.string,
      enumMap: _ExpensecategoryEnumEnumValueMap,
    ),
...
int _expenseEstimateSize(
  ...
  {
    final value = object.categoryEnum;
    if (value != null) {
...
void _expenseSerialize(
  ...
  writer.writeString(offsets[1], object.categoryEnum?.name);
...
Expense _expenseDeserialize(
  ...
  object.categoryEnum =
      _ExpensecategoryEnumValueEnumMap[reader.readStringOrNull(offsets[1])];
...
P _expenseDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (_ExpensecategoryEnumValueEnumMap[reader.readStringOrNull(offset)])
          as P;
    case 2:
...
const _ExpensecategoryEnumEnumValueMap = {
  r'bills': r'bills',
  r'food': r'food',
  r'clothes': r'clothes',
...
const _ExpensecategoryEnumValueEnumMap = {
...
void _expenseAttach(IsarCollection<dynamic> col, Id id, Expense object) {
  object.id = id;
  object.receipts.attach(col, col.isar.collection<Receipts>(), r'receipts', id);
}
...
extension ExpenseQueryFilter
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> categoryEnumIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'categoryEnum',
      ));
    });
  }

  QueryBuilder<Expense, Expense, QAfterFilterCondition>
      categoryEnumIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> categoryEnumEqualTo(
    CategoryEnum? value, {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> categoryEnumGreaterThan(
    CategoryEnum? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> categoryEnumLessThan(
    CategoryEnum? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> categoryEnumBetween(
    CategoryEnum? lower,
    CategoryEnum? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> categoryEnumStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> categoryEnumEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> categoryEnumContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> categoryEnumMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> categoryEnumIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'categoryEnum',
        value: '',
...
extension ExpenseQueryLinks
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> receipts(
      FilterQuery<Receipts> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'receipts');
    });
  }

  QueryBuilder<Expense, Expense, QAfterFilterCondition> receiptsIsNull() {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseQuerySortBy on QueryBuilder<Expense, Expense, QSortBy> {
  ...
  QueryBuilder<Expense, Expense, QAfterSortBy> sortByCategoryEnum() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'categoryEnum', Sort.asc);
    });
  }

  QueryBuilder<Expense, Expense, QAfterSortBy> sortByCategoryEnumDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'categoryEnum', Sort.desc);
    });
  }
...
extension ExpenseQuerySortThenBy
  ...
  QueryBuilder<Expense, Expense, QAfterSortBy> thenByCategoryEnum() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'categoryEnum', Sort.asc);
    });
  }

  QueryBuilder<Expense, Expense, QAfterSortBy> thenByCategoryEnumDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'categoryEnum', Sort.desc);
    });
  }
...
extension ExpenseQueryWhereDistinct
  ...
  QueryBuilder<Expense, Expense, QDistinct> distinctByCategoryEnum(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'categoryEnum', caseSensitive: caseSensitive);
    });
  }
...
extension ExpenseQueryProperty
  ...
  QueryBuilder<Expense, CategoryEnum?, QQueryOperations>
      categoryEnumProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'categoryEnum');
    });
  }
